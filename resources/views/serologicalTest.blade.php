<x-app-layout>
    ...
    <div class="p-4 sm:ml-64 h-full justify-center flex flex-col">
        <form class="w-3/4 mx-auto" method="POST" action="{{ route('serologicalTest.submit', ['path_no' => $id->path_no])}}">
            @csrf
            ...
            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">H. pylori</label>
            <div class="flex gap-8">
                <div class="flex items-center px-4 border border-gray-200 rounded dark:border-gray-700">
                    <input  id="sex" type="radio" value="Reactive" @checked($id->h_pylori == "Reactive") value="Reactive"  name="h_pylori"
                        class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="bordered-radio-2"
                        class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Reactive
                    </label>
                ...
                <div class="flex items-center px-4 border border-gray-200 rounded dark:border-gray-700">
                    <input  id="hepatitis_b" type="radio" value="Non-reactive" @checked($id->h_pylori == "Non-reactive") name="h_pylori"
                        class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="bordered-radio-2"
                        class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Not Reactive</label>
                </div>
            ...
            <label for="vdrl" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">VDRL</label>
            <div class="flex gap-8">
                <div class="flex items-center px-4 border border-gray-200 rounded dark:border-gray-700">
                    <input  id="vdrl" type="radio" value="Reactive" @checked($id->vdrl == "Reactive") value="Reactive"  name="vdrl"
                        class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="bordered-radio-2"
                        class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Reactive
                    </label>
                ...
                <div class="flex items-center px-4 border border-gray-200 rounded dark:border-gray-700">
                    <input  id="hepatitis_b" type="radio" value="Non-reactive" @checked($id->vdrl == "Non-reactive") name="vdrl"
                        class="w-4 h-4 text-blue-600 cursor-pointer bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    <label for="bordered-radio-2"
                        class="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Not Reactive</label>
                </div>
            ...
            <button type="submit"
                class="text-white my-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save</button>
