        ...
        <form class="w-3/4 mx-auto">
            <div class="mb-6">
                ...
                <input type="name" id="name" name="name"
                    ...
                    placeholder="Ahmed Zubairu" required>
            </div>
            ...
            <label for="level" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an
                option</label>
            ...
            <div class="mb-6">
                <label for="contact" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Path
                    No</label>
                <input type="text" name="path_no" id="path_no" disabled value="{{ $path_no }}"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    required>
            </div>
